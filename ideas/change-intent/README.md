...
A structured artifact authored *before any code is written* for a change. It captures why the change is being made and what externally observable claims the implementation must prove.

See [design.md](design.md) for the full design and the authoring-skill specification.
