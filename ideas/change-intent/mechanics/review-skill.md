...
- **The amendment check as an algorithm.** The joins, spelled out: the final text equals the most recent approval commit's text plus the amendment entries dated after it (re-approval after a reopening resets this starting point); every entry since that commit has a discovery note on its claim and every discovery note has an entry; dates are consistent; relaxations also landed in Out of scope.
