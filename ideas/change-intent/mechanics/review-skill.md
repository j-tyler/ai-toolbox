...
- **Custody as an algorithm.** The ledger↔body joins, spelled out: every ledger entry has body residue, every residue marker has a ledger entry, dates are consistent, relaxations also landed in Out of scope, and the final text matches what the intent author last approved.
