...
- A section with nothing to hold is omitted (Outcomes and Why always have something to hold). Absence is meaningful — an absent Amendments section means the current approved baseline held as written during implementation.
