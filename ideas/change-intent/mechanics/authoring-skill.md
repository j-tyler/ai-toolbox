...
- **Cold start.** The request is the first answer: sort whatever outcomes, why, and constraints it already states into the template, and ask — in one message — only for what it does not supply. Do not run a questionnaire. A bare one-sentence request is a cold start, not a harvest.
